...
class _$ResponseErrorImpl extends _ResponseError with DiagnosticableTreeMixin {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(DiagnosticsProperty('type', 'NetworkException.request'))
...
class _$DecodingErrorImpl extends _DecodingError with DiagnosticableTreeMixin {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'NetworkException.type'))
      ..add(DiagnosticsProperty('error', error));
  }
...
class _$ConnectivityImpl extends _Connectivity with DiagnosticableTreeMixin {
  const _$ConnectivityImpl({this.message = 'No internet access!'}) : super._();
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'NetworkException.connectivity'))
...
class _$TimeOutImpl extends _TimeOut with DiagnosticableTreeMixin {
  const _$TimeOutImpl({this.message = 'The request time has expired!'})
      : super._();
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'NetworkException.timeOut'))
      ..add(DiagnosticsProperty('message', message));
  }
